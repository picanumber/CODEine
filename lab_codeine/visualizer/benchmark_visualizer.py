...
def print_data_stats(datalist, name): 
    ...
    print("mean (average)          : {0:.4f}".format(stat.mean(datalist)))           
    print("median (middle value)   : {0:.4f}".format(stat.median(datalist)))
    print("median_low              : {0:.4f}".format(stat.median_low(datalist)))
    print("median_high             : {0:.4f}".format(stat.median_high(datalist)))   
    print("median_grouped          : {0:.4f}".format(stat.median_grouped(datalist)))
    try: 
        print("mode (most common value): {0:.4f}".format(stat.mode(datalist)))
    except Exception as err:
        print("mode: {}".format(err))
    print("------------------------------------------ measures of spread")
    print("population standard deviation: {0:.4f}".format(stat.pstdev(datalist)))
    print("population variance          : {0:.4f}".format(stat.pvariance(datalist)))
    print("sample standard deviation    : {0:.4f}".format(stat.stdev(datalist)))
    print("sample variance              : {0:.4f}".format(stat.variance(datalist)))
    print("----------------------------------------------------- extends")
    print("sample min: {0:.4f}".format(min(datalist)))
    print("sample max: {0:.4f}".format(max(datalist)))
    print("=============================================================")
# -----------------------------------------------------------------------   
