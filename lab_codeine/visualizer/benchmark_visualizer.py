...
def print_data_stats(datalist, name): 
    ...
    print("median (middle value)   : {}".format(round(stat.median(datalist), 3)))
    print("median_low              : {}".format(round(stat.median_low(datalist), 3)))
    print("median_high             : {}".format(round(stat.median_high(datalist), 3)))   
    print("median_grouped          : {}".format(round(stat.median_grouped(datalist), 3)))
    try: 
        print("mode (most common value): {}".format(round(stat.mode(datalist), 3)))
    except Exception as err:
        print("mode: {}".format(err))
    print("------------------------------------------ measures of spread")
    print("population standard deviation: {}".format(round(stat.pstdev(datalist), 3)))
    print("population variance          : {}".format(round(stat.pvariance(datalist), 3)))
    print("sample standard deviation    : {}".format(round(stat.stdev(datalist), 3)))
    print("sample variance              : {}".format(round(stat.variance(datalist), 3)))
    print("----------------------------------------------------- extends")
